...
def main():
    ...
    if flask.request.method == 'POST':
      ...
      #  print(roveg1, roadsurf1, light1, weather1, cclass1, typeveg1, usernameins, place)
        ...
        #creating variable for connection
        cursor = mysql.connection.cursor(MySQLdb.cursors.DictCursor)
        cursor.execute('INSERT INTO accidentdetails VALUES (NULL, % s, % s, % s, % s, % s, % s, %s, NULL, % s, % s)', (roveg1, roadsurf1, light1, weather1, cclass1,typeveg1,prediction,usernameins,place,))
        mysql.connection.commit()
